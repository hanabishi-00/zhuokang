...
import static com.huake.device.dao.generator.EvaResTur20200001MidDynamicSqlSupport.*;
import static org.mybatis.dynamic.sql.SqlBuilder.*;

import com.huake.device.domain.generator.EvaResTur20200001Mid;
...
public interface EvaResTur20200001MidMapper {
    ...
    BasicColumn[] selectList = BasicColumn.columnList(timeOnline, unit, timeOffline, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15, v16, v17, v18, v19, v20, v21, v22, v23, v24, v25, v26);
    ...
    int insert(InsertStatementProvider<EvaResTur20200001Mid> insertStatement);

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    @InsertProvider(type=SqlProviderAdapter.class, method="insertMultiple")
    int insertMultiple(MultiRowInsertStatementProvider<EvaResTur20200001Mid> multipleInsertStatement);

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ResultMap("EvaResTur20200001MidResult")
    Optional<EvaResTur20200001Mid> selectOne(SelectStatementProvider selectStatement);

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @Results(id="EvaResTur20200001MidResult", value = {
        @Result(column="time_online", property="timeOnline", jdbcType=JdbcType.INTEGER, id=true),
        @Result(column="unit", property="unit", jdbcType=JdbcType.TINYINT, id=true),
        @Result(column="time_offline", property="timeOffline", jdbcType=JdbcType.INTEGER),
    ...
    List<EvaResTur20200001Mid> selectMany(SelectStatementProvider selectStatement);
    ...
    default long count(CountDSLCompleter completer) {
        return MyBatis3Utils.countFrom(this::count, evaResTur20200001Mid, completer);
    }

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default int delete(DeleteDSLCompleter completer) {
        return MyBatis3Utils.deleteFrom(this::delete, evaResTur20200001Mid, completer);
    }

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default int deleteByPrimaryKey(Integer timeOnline_, Byte unit_) {
        return delete(c -> 
            c.where(timeOnline, isEqualTo(timeOnline_))
            .and(unit, isEqualTo(unit_))
        );
    }

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default int insert(EvaResTur20200001Mid record) {
        return MyBatis3Utils.insert(this::insert, record, evaResTur20200001Mid, c ->
            c.map(timeOnline).toProperty("timeOnline")
            .map(unit).toProperty("unit")
            .map(timeOffline).toProperty("timeOffline")
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default int insertMultiple(Collection<EvaResTur20200001Mid> records) {
        return MyBatis3Utils.insertMultiple(this::insertMultiple, records, evaResTur20200001Mid, c ->
            c.map(timeOnline).toProperty("timeOnline")
            .map(unit).toProperty("unit")
            .map(timeOffline).toProperty("timeOffline")
            .map(v1).toProperty("v1")
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default int insertSelective(EvaResTur20200001Mid record) {
        return MyBatis3Utils.insert(this::insert, record, evaResTur20200001Mid, c ->
            c.map(timeOnline).toPropertyWhenPresent("timeOnline", record::getTimeOnline)
            .map(unit).toPropertyWhenPresent("unit", record::getUnit)
            .map(timeOffline).toPropertyWhenPresent("timeOffline", record::getTimeOffline)
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default Optional<EvaResTur20200001Mid> selectOne(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectOne(this::selectOne, selectList, evaResTur20200001Mid, completer);
    }

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default List<EvaResTur20200001Mid> select(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectList(this::selectMany, selectList, evaResTur20200001Mid, completer);
    }

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default List<EvaResTur20200001Mid> selectDistinct(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectDistinct(this::selectMany, selectList, evaResTur20200001Mid, completer);
    }

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default Optional<EvaResTur20200001Mid> selectByPrimaryKey(Integer timeOnline_, Byte unit_) {
        return selectOne(c ->
            c.where(timeOnline, isEqualTo(timeOnline_))
            .and(unit, isEqualTo(unit_))
        );
    ...
    default int update(UpdateDSLCompleter completer) {
        return MyBatis3Utils.update(this::update, evaResTur20200001Mid, completer);
    }

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    static UpdateDSL<UpdateModel> updateAllColumns(EvaResTur20200001Mid record, UpdateDSL<UpdateModel> dsl) {
        return dsl.set(timeOnline).equalTo(record::getTimeOnline)
                .set(unit).equalTo(record::getUnit)
                .set(timeOffline).equalTo(record::getTimeOffline)
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    static UpdateDSL<UpdateModel> updateSelectiveColumns(EvaResTur20200001Mid record, UpdateDSL<UpdateModel> dsl) {
        return dsl.set(timeOnline).equalToWhenPresent(record::getTimeOnline)
                .set(unit).equalToWhenPresent(record::getUnit)
                .set(timeOffline).equalToWhenPresent(record::getTimeOffline)
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default int updateByPrimaryKey(EvaResTur20200001Mid record) {
        return update(c ->
            c.set(timeOffline).equalTo(record::getTimeOffline)
            .set(v1).equalTo(record::getV1)
            .set(v2).equalTo(record::getV2)
            .set(v3).equalTo(record::getV3)
            .set(v4).equalTo(record::getV4)
            ...
            .set(v25).equalTo(record::getV25)
            .set(v26).equalTo(record::getV26)
            .where(timeOnline, isEqualTo(record::getTimeOnline))
            .and(unit, isEqualTo(record::getUnit))
        );
    }

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default int updateByPrimaryKeySelective(EvaResTur20200001Mid record) {
        return update(c ->
            c.set(timeOffline).equalToWhenPresent(record::getTimeOffline)
            .set(v1).equalToWhenPresent(record::getV1)
            .set(v2).equalToWhenPresent(record::getV2)
            .set(v3).equalToWhenPresent(record::getV3)
            .set(v4).equalToWhenPresent(record::getV4)
