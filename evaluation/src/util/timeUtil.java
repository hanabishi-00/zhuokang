...
public class timeUtil {
    ...
    public static void main(String[] args) throws ParseException {
        long long_time=stringToLong("2019-12-01 01:00:00","yyyy-MM-dd HH:mm:ss");
        System.out.println(long_time/1000);
    }
    ...
    public static String[] getYMDHMS(Date date){//以String格式返回年月日小时分钟秒
        ...
        String time;
        time=timeUtil.dateToString(date,"yyyy-MM-dd HH:mm:ss");
